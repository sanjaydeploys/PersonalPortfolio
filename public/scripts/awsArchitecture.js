const AWSArchitecture = {
  init(canvas, tooltip) {
    ...
    const drawService = (service, highlight = false) => {
      ...
      ctx.fillStyle = highlight ? 'rgba(255, 255, 0, 0.8)' : ({ gateway: '#1E90FF', compute: '#32CD32', database: '#FFD700', storage: '#FF4500', cdn: '#BA55D3', messaging: '#FF69B4', monitoring: '#4682B4', auth: '#6A5ACD' }[service.type] || '#808080');
      ctx.fill();
