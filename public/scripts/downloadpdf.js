document.addEventListener('DOMContentLoaded', function() {
  ...
  script.onload = function() {
    ...
    // Target the hero-cta container to add the Download PDF button
    const heroCta = document.querySelector('.hero-cta');
    if (heroCta) {
      const downloadButton = document.createElement('a');
      downloadButton.classList.add('cta-button', 'download-pdf');
      downloadButton.innerHTML = `
        <span lang="en" class="lang-hidden">Download PDF Version</span>
        <span lang="hi" class="lang-visible">PDF संस्करण डाउनलोड करें</span>
      `;
      downloadButton.href = '#';
      heroCta.appendChild(downloadButton);
